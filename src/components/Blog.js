...
const Blog = () => {
    return (
        <div>
            ...
            <div className=' p-5 rounded m-5' style={{ background: 'linear-gradient(to right, rgba(250, 220, 47), rgba(118, 75, 162, 0.5))'}}>
            ...
            <div className=' p-5 rounded m-5' style={{ background: 'linear-gradient(to right, rgba(157, 223, 245), rgba(118, 75, 162, 0.5))'}}>
            ...
            <div className=' p-5 rounded m-5' style={{ background: 'linear-gradient(to right, rgba(173, 242, 104), rgba(118, 75, 162, 0.5))'}}>
            ...
            <div className=' p-5 rounded m-5' style={{ background: 'linear-gradient(to right, rgba(245, 105, 138), rgba(118, 75, 162, 0.5))'}}>
